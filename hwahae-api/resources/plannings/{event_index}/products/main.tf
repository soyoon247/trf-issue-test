  ...
  method_values = {
    GET = {
      method_request_parameters = {
        ...
        "method.request.querystring.layout_type" = "true"
      }
      method_response_map = {
        200 = {
          response_parameters = {
      ...
      integration_request_parameters = {
        ...
        "integration.request.querystring.layout_type" = "method.request.querystring.layout_type"
      }
      integration_type = var.args.integration_type.HTTP
      integration_uri  = "http://$${stageVariables.HWAHAE_SERVER_API_ALB}/$${stageVariables.version}/plannings/{event_index}/products"
