module "check-crew-member-type_resources" {
  source      = "app.terraform.io/hh-devops/api-gateway-modules/aws"
  version     = "1.0.0"
  rest_api_id = var.args.rest_api_id
  parent_id   = var.parent_id
  path_part   = "check-crew-member-type"
  ...
  method_values = {
    ...
    POST = {
      ...
      integration_uri = "http://$${stageVariables.HWAHAE_SERVER_API_ALB}/$${stageVariables.version}/special-offers/users/me/check-crew-member-type"
    }
  }
}
