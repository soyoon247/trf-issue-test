module "comments_resources" {
  ...
  common_values = {
    ...
    integration_uri = "http://$${stageVariables.HWAHAE_SERVER_API_ALB}/$${stageVariables.version}/reviews/{review_index}/comments"
  }
  method_values = {
    GET  = {}
    POST = {}
...
module "comment_index" {
  source    = "./{comment_index}"
