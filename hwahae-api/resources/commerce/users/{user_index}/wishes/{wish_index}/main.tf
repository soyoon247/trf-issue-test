module "wish_index_resources" {
  source      = "app.terraform.io/hh-devops/api-gateway-modules/aws"
  version     = "1.0.8"
  rest_api_id = var.args.rest_api_id
  parent_id   = var.parent_id
  path_part   = "{wish_index}"
  ...
  method_values = {
    DELETE = {
      ...
      integration_request_parameters = {
        ...
        "integration.request.path.wish_index" = "method.request.path.wish_index"
      }
      integration_uri = "http://$${stageVariables.HWAHAE_COMMERCE_SERVER}/users/{user_index}/wishes/{wish_index}"
