module "downloadable_resources" {
  source      = "app.terraform.io/hh-devops/api-gateway-modules/aws"
  version     = "1.0.8"
  rest_api_id = var.args.rest_api_id
  parent_id   = var.parent_id
  path_part   = "downloadable"
  ...
  method_values = {
    GET = {
      ...
      method_request_parameters = {
        "method.request.querystring.coupon_type" = "false"
      ...
      integration_uri = "http://$${stageVariables.HWAHAE_COMMERCE_SERVER}/coupons/downloadable"
