module "return_resources" {
  ...
  method_values = {
    ...
    POST = {
      ...
      integration_uri = "http://$${stageVariables.HWAHAE_COMMERCE_SERVER}/orders/{order_code}/return"
      integration_response_map = {
        200 = {}
      }
    }
...
module "calculate" {
  source    = "./calculate"
  parent_id = module.return_resources.resource_id
  args      = var.args
}
