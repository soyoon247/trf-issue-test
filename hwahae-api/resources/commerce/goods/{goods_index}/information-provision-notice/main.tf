module "information-provision-notice_resources" {
  source      = "app.terraform.io/hh-devops/api-gateway-modules/aws"
  version     = "1.0.8"
  rest_api_id = var.args.rest_api_id
  parent_id   = var.parent_id
  path_part   = "information-provision-notice"
  ...
  method_values = {
    GET = {
      ...
      integration_uri = "http://$${stageVariables.HWAHAE_COMMERCE_SERVER}/$${stageVariables.HWAHAE_COMMERCE_SERVER_VERSION}/goods/{goods_index}/information-provision-notice"
