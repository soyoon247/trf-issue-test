module "points_resources" {
  ...
  method_values = {
    GET = {
      ...
      integration_uri = "http://$${stageVariables.HWAHAE_SERVER_API_ALB}/$${stageVariables.version}/attendances/users/me/points"
    }
    OPTIONS = {
...
module "point_type_id" {
  ...
  parent_id = module.points_resources.resource_id
  args      = var.args
}
